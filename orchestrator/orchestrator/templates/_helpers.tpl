...
ArgoCD Syncwave
*/}}
{{- define "orchestrator.argocd-syncwave" -}}
{{- if .Values.argocd }}
{{- if and (.Values.argocd.orchestrator.syncwave) (.Values.argocd.enabled) -}}
argocd.argoproj.io/sync-wave: "{{ .Values.argocd.orchestrator.syncwave }}"
{{- else }}
{{- "{}" }}
{{- end }}
{{- else }}
